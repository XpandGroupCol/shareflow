...
import { copyValues, getPublisherRow, getSummaryInformation, getTotalShare } from 'utils/publishersFormat'
  ...
  return (
    <>
      <section className='headerSection'>
        ...
        >
          <BackButton onBack={handleOnBack} href={href} />
